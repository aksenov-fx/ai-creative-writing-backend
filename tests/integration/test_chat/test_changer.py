...
@pytest.mark.parametrize("prompt_type,story_file,callback,should_pass,arg", changer_params)
def test_module(prompt_type, story_file, callback, should_pass, arg):
    chat_test(prompt_type, story_file, callback, "Changer", should_pass, arg)